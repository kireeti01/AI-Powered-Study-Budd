...
class StreamlitApp:
        ...
        with tab1:
            ...
            if st.button("✨ Generate Flashcards", use_container_width=True, key="flashcard_btn"):
                if not topic.strip():
                    ...
                    with st.spinner(f"🤔 Creating flashcards..."):
                        try:
    ...
    def show_qa_engine(self):
        ...
        if uploaded_file:
            if st.button("📚 Load Material", use_container_width=True, key="load_qa_btn"):
                with st.spinner("📖 Loading material..."):
                    try:
                        ...
                        st.session_state.qa_context_loaded = True
            ...
            if st.session_state.qa_context_loaded:
                st.write("---")
                        ...
                        with st.spinner("🤔 Finding the answer..."):
                            try:
                                ...
                                with st.expander("💡 Suggested Follow-up Questions"):
                                    follow_ups = self.qa_engine.generate_follow_up_questions(question)
            ...
            st.info("👆 Upload study material to get started")
    ...
    def run(self):
        ...
        with st.sidebar:
            ...
            with st.expander("ℹ️ About"):
                st.markdown("""
                **AI Study Buddy** is an AI-powered learning platform designed to help students master any subject.
